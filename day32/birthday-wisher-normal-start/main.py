...
data = pd.read_csv("day32/birthday-wisher-normal-start/birthdays.csv")
...
if today_tuple in birthdays_dict:
    ...
    file_path = f"day32/birthday-wisher-normal-start/letter_templates/letter_{random.randint(1,3)}.txt"
